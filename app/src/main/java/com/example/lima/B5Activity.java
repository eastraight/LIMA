...
/* B5 - Crianza positiva */
public class B5Activity extends AppCompatActivity implements View.OnClickListener {
    Button b5_1, b5_2, b5_3, b5_4, b5_5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout1 = findViewById(R.id.b5_1layout);
        layout2 = findViewById(R.id.b5_2layout);
        layout3 = findViewById(R.id.b5_3layout);
        layout4 = findViewById(R.id.b5_4layout);
        layout5 = findViewById(R.id.b5_5layout);
